...
public interface IWrapDevice extends Remote
{
	...
	/**
	 * Gets the power-related environment properties of the device.
	 * 
	 * @return an instance of the {@link PowerProperties} data container.
	 * @throws RemoteException
	 * @throws CommandFailedException
	 */
	...
	/**
	 * Sets the power-related environment properties of the device.
	 * 
	 * @param properties
	 *        - new power related environment properties to be applied.
	 * @throws RemoteException
	 * @throws CommandFailedException
	 */
